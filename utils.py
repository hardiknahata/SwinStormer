...
def parse_args():
    desc = 'Pytorch Implementation of \'SwinStormer: High-Resolution Image Deraining\''
    ...
    parser.add_argument('--num_iter', type=int, default=240000, help='iterations of training')
    ...
    parser.add_argument('--patch_size', nargs='+', type=int, default=[224, 224, 224, 224, 224, 224],
